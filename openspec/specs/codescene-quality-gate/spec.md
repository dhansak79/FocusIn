...
Defines how the CodeScene `cs delta main` health check integrates into the swamp quality pipeline, what data is stored per run, and how the pre-commit hook transitions to using the workflow exclusively.
