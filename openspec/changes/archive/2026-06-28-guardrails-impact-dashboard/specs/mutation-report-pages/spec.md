...
The `upload-pages-artifact` action in `mutation.yml` SHALL upload a staging directory (`reports/pages/`) assembled before upload. The staging directory SHALL be structured as:
